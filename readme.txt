...
Installing "My Awesome Plugin" can be done either by searching for "My Awesome Plugin" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
